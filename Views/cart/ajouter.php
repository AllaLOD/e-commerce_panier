...
<h2 class="text-center my-5">Votre panier :</h2>
    <div class="col-md-10 mx-auto col-sm-12 table_panier">
    <table class="table table-bordered text-center table-responsive my-5 shadow">
        <thead>
            <tr>
                <th>Titre</th>
    ...
    <?php else: ?>
        <div class="d-flex flex-column text-center my-5"> 
            ...
            <h4>ou</h4>
            <a href="/users/register"><button type="button" class="btn btn_ajouter  mb-5">Inscrivez-vous</button></a>
        </div>
